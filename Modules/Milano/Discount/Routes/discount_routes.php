...
Route::group(["middleware" => "auth"], function ($router){
    $router->get("/discounts",  ["as" => "discounts.index", "uses" => "DiscountController@index"]);
    ...
    $router->get("/discounts/{code}/{product}/check", "DiscountController@check")->name("discounts.check")->middleware("throttle:6,1");
});
