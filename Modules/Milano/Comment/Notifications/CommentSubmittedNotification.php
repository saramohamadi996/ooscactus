...
namespace Milano\Comment\Notifications;

use Milano\Comment\Mail\CommentSubmittedMail;
...
class CommentSubmittedNotification extends Notification
{
    ...
    public function toTelegram($notifiable)
    {
        ...
        return TelegramMessage::create()
            ...
            ->content("یک دیدگاه جدید برای محصول ی شما در اوس کاکتوس ارسال شده است.")
            ->button('مشاهده محصول', $this->comment->commentable->path())
            ->button('مدیریت دیدگاه ها', route("comments.index"));
    }

    public function toSMS($notifiable)
    {
        return 'یک دیدگاه جدید برای محصول ی شما در اوس کاکتوس ارسال شده است. جهت مشاهده و ارسال پاسخ روی لینک زیر کلیک فرمایید.' . "\n" .  route("comments.index");
    }
